...
export default function LandingPage() {
      ...
      `}</style>
                  ...
                  >
                              ...
                              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                                    <div className="text-center max-w-4xl mx-auto">
                                          <Chip
                                                ...
                                                variant="outlined"
                                                className="walmart-chip mx-auto"
                                          />

                                          <h1
                                                className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight my-6"
                                                style={{
                                                      color: "var(--walmart-dark)",
                                                }}
                                          >
                                          ...
                                          >
                                                Eliminate checkout queues and
                                                complex store layouts. Our
                                                intelligent system guides
                                                customers efficiently while
                        ...
                        <section
                              className="py-16"
                              style={{ background: "var(--walmart-muted)" }}
                        >
                              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                                    <div className="max-w-3xl mx-auto text-center">
                                          ...
                                          >
                                                ...
                                                navigate complex layouts and
                                                endure long checkout queues.
                                                This friction alienates
                                                time-conscious shoppers who
                                                value convenience but still
                                                desire the tactile satisfaction
                              ...
                              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                                    ...
                                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                                          {features.map((feature, index) => (
                                                <Card
                                                      key={index}
                                                      className="walmart-card shadow-sm hover:shadow-md transition-shadow"
                                                >
                                                      <CardHeader
                                                            title={
                                                                  feature.title
                              ...
                              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                                          ...
                                          <div
                                                ...
                                                style={{
                                                      background:
                                                            "linear-gradient(135deg, rgba(0,113,206,0.04), rgba(255,194,32,0.06))",
                                                }}
                                          >
                                                <div className="grid grid-cols-2 gap-6 text-center">
                                                      <div>
                                                            <div className="text-3xl walmart-stat mb-2">
                                                                  75%
                                                            </div>
                                                            <div
                                                                  className="text-sm"
                        ...
                        <section className="py-20">
                              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                                    <div className="rounded-2xl p-8 lg:p-12 text-center walmart-hero-cta">
                                          ...
                                          >
                                                Join the future of retail with
                                                our intelligent navigation and
                                                management system. Start your
                                                free trial today.
                                          </p>
                              ...
                              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                                    <div className="grid md:grid-cols-4 gap-8">
                                          <div className="col-span-2">
                                                ...
                                                >
                                                      Revolutionizing physical
                                                      retail with intelligent
