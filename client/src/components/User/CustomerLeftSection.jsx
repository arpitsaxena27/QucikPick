...
import shelfData from "./shelves.json";
import mapImage from "../../assets/images/arpit_ka_map.png";
...
function CustomerLeftSection({ selectedProduct, onShelfSelect }) {
  ...
  return (
    <>
      {/* Control Buttons */}
      <div
        className={`flex items-center absolute top-32 md:top-24 left-4 z-10 space-y-2 ${isCollapsed ? "flex-row gap-1" : "flex-col"
          } md:h-screen`}
      >
        <button
      ...
      <div
        ...
        className={`mt-1 w-full md:w-3/4 ${
          isCollapsed ? "h-[150px]" : "h-[40vh] md:h-[90vh]"
      ...
      >
        <div className="flex items-center justify-center flex-grow min-w-max min-h-max">
          <div
